...
const PRODUTOS_DB = [
  {
    ...
    imagens: ['img/brasil-1-2627-1.jpg', 'img/brasil-1-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    preco: 189.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/argentina-1-2627.jpg', 'img/argentina-1-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    preco: 179.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/espanha-1-2627.jpg', 'img/espanha-1-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    preco: 179.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/espanha-2-2627.jpg', 'img/espanha-2-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
    estoque: { P: 0, M: 0, G: 0, GG: 0 }
  },
  {
    ...
    preco: 169.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/portugal-1-2627.jpg', 'img/portugal-1-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    preco: 169.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/portugal-2-2627.jpg', 'img/portugal-2-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
    estoque: { P: 0, M: 0, G: 0, GG: 0 }
  },
  {
  ...
  },
  {
    ...
    preco: 189.9,
    descricao: 'Versão torcedor com tecido leve e respirável',
    imagens: ['img/argentina-2-2627.jpg', 'img/argentina-2-2627-2.jpg'],
    tamanhos: ['P', 'M', 'G', 'GG'],
    estoque: { P: 0, M: 0, G: 0, GG: 0 }
  },
  {
